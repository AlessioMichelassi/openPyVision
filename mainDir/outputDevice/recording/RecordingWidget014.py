...
from mainDir.outputDevice.recording.recordingInfoWidget import RecordingInfoWidget
from mainDir.outputDevice.recording.recordingManager import RecordingManager
