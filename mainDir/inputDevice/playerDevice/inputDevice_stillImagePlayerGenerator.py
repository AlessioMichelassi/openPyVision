...
from mainDir.inputDevice.playerDevice.playerWidget.stillImagePlayerWidget import StillImagePlayerWidget
from mainDir.inputDevice.playerDevice.inputObject.player_StillImage import StillImagePlayer


class InputDevice_StillImagePlayer(InputDevice_BaseClass):
    """
