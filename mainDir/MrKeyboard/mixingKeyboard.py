...
from mainDir.MrKeyboard.mixerKeyboard.blinkingButton import BlinkingButton
from mainDir.MrKeyboard.styles.btnStyle import btnSpecialStyle, btnGreenStyle, btnRedStyle, btnCutStyle
from mainDir.MrKeyboard.styles.lblWidget import LblWidget
...
class MixerKeyboard(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.cmbEffect.addItems(["Fade", "Wipe Left to Right", "Wipe Right to Left",
                                 "Wipe Top to Bottom", "Wipe Bottom to Top", "Wipe Stinger", "Still1"])
    ...
    def parseTallySignal(self, tally_status):
...
if __name__ == "__main__":
    ...
    window.parseTallySignal(external_tally)
    nick_nameTest = {
        'cmd': 'nickNameChanged',
        'position': '2',
        'nickName': 'Camera 2'
    }
    window.parseTallySignal(nick_nameTest)
    sys.exit(app.exec())
