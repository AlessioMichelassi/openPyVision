...
from mainDir.mixBus.stingerInputLoader_03_thread import StingerLoaderThread03, StingerDisplay
...
class DataManager(QObject):
    ...
    def getStillObject(self):
        self.stillObject = StillImagePlayer(self.stillImagePath, None)
